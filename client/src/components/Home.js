        ...
        <div className="card-body">
          <blockquote className="blockquote mb-0">
            <p className="fs-6 text-center">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sunt est alias optio. Quia nam consequuntur, provident corrupti ab, adipisci est eveniet voluptas velit earum debitis amet illum illo? Corporis accusamus recusandae quos molestiae suscipit harum.
            </p>
